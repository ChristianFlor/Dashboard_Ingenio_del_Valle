...
function createSectorDisplay(sector) {
    ...
    aCol = "<a href='#sector'"+sector+"class='d-block card-header py-3' data-toggle='collapse' role='button' aria-expanded='true' aria-controls='collapseCardExample'> <h6 class='m-0 font-weight-bold text-primary'>Sector 0"+sector+"</h6> </a>";
